...
export const TdsIcons = {
  ...
  Fingerprint: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M4.5 13.6c.03-3.9 3.3-7.1 7.5-7.1 4.24 0 7.5 3.22 7.5 7.1" />
      <path d="M8 12c0-2.2 1.8-4 4-4s4 1.8 4 4" />
      <path d="M6 18c0-4.42 2.69-8 6-8s6 3.58 6 8" />
    </svg>
  ),
  Document: () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export interface TdsTaxpayerProfile {
  name?: string
  fullName: string
  pan: string
  aadhaar: string
...
export const DEFAULT_TDS_TAXPAYER: TdsTaxpayerProfile = {
  name: '',
  fullName: '',
  pan: '',
  aadhaar: '',
