...
export const GSTStatusTimeline: React.FC = () => {
  return (
    <div className="gst-status-main-col">
      ...
      {/* CA Assigned Support Card */}
      <div className="gst-status-ca-card">
        <div className="gst-status-ca-card__avatar">
          <span role="img" aria-label="Chartered Accountant">👨‍💼</span>
        </div>
        <div className="gst-status-ca-card__info">
          <h4 className="gst-status-ca-card__name">Assigned CA: Rohit Kulkarni</h4>
          <p className="gst-status-ca-card__role">Senior Chartered Accountant · GST Verification Team</p>
          <p className="gst-status-ca-card__text">
            Your application documents are currently undergoing review. If any clarification is needed, we will reach out directly.
          </p>
        </div>
      </div>
    </div>
